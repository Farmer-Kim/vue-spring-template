 ...
 * <li>설	 명  = Request, Servlet 관련 유틸 class</li>
...
public class ServletUtil {
	...
	// 외부연동의 경우 메뉴 정보 조회 안하게
	public static boolean isSsoRequest(HttpServletRequest request) {

		if(request.getRequestURI().equals(request.getContextPath() + "/getUserLogBpm")){
			return true;
		}
